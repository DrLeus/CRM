...
public class DatabaseConnection {
    ...
    static {
        try {
            ...
            try {
                ...
                try {
                    throw new CRMException("Couldn't register driver in case -", e1);
                } catch (CRMException e2) {
                    e2.printStackTrace();
                }
            }
        }
    ...
    public Connection getConnection() throws CRMException {
        try {
            ...
            throw new CRMException("Couldn't get connection in case -", e);
        }
    }
