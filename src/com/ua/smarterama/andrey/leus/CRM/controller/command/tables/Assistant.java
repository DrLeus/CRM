...
import java.util.MissingFormatArgumentException;
 ...
 public class Assistant {
    ...
    public static void outputColumnNames(List<Object> listColumnName, String result, Console view) {
        System.out.println(String.format(result, listColumnName.toArray()));
    }

    public static void outputData(List<Object> listColumnName, List<Object> listValue, String result, Console view) {
        try {
            do {
    ...
    private static int getWidthColumn(int i, List<Object> listColumnName, List<Object> listValue) {
     ...
     public static List<String> inputNames(Console view) {
