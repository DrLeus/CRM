...
public class UpdateDate extends Command {
    ...
    public void update() throws CRMException {
        ...
        try {
            view.outputColumnNames(columnNames, view.getFormatedLine(columnNames, manager.getTableData(tableName, "")));
            view.outputData(columnNames, manager.getTableData(tableName, ""), view.getFormatedLine(columnNames, manager.getTableData(tableName, "")));
        } catch (CRMException e) {
