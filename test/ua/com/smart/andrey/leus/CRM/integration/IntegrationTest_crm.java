package ua.com.smart.andrey.leus.CRM.integration;

import ua.com.smart.andrey.leus.CRM.integration.LogOutputStream;
import ua.com.smart.andrey.leus.CRM.controller.Main;
import ua.com.smart.andrey.leus.CRM.controller.command.Help;
...
public class IntegrationTest_crm {
    ...
    @BeforeClass
    public static void init() throws CRMException, ClassNotFoundException {
    ...
    @After
    public void clearAfterTest() throws CRMException {
    }
